...
test_base32 (void)
{
  ...
  tr_base32_decode ("LFHVSTZB", 8, NULL, &buffer_size);
  check_uint_eq (5, buffer_size);

  tr_base32_decode ("LFHVSTZB", 8, buffer, &buffer_size);
  check_uint_eq (5, buffer_size);
  buffer[buffer_size] = '\0';
  check_streq ("YOYO!", buffer);

  tr_base32_decode ("OBSXEIDBONYGK4TBEBQWIIDBON2HEYI=", 32, NULL, &buffer_size);
  check_uint_eq (19, buffer_size);

  tr_base32_decode ("OBSXEIDBONYGK4TBEBQWIIDBON2HEYI=", 32, buffer, &buffer_size);
  check_uint_eq (19, buffer_size);
  buffer[buffer_size] = '\0';
  check_streq ("per aspera ad astra", buffer);

  tr_base32_decode ("AAAQEAYEAUDAOCAJBIFQYDIOB4IBCEQTCQKRMFYYDENBWHA5DYPSAIJCEMSCKJRHFAUSUKZMFUXC6MBRGIZTINJWG44DSOR3HQ6T"
                    ...
                    "7L57Z7P674======", 416, NULL, &buffer_size);
  check_uint_eq (256, buffer_size);

  tr_base32_decode ("AAAQEAYEAUDAOCAJBIFQYDIOB4IBCEQTCQKRMFYYDENBWHA5DYPSAIJCEMSCKJRHFAUSUKZMFUXC6MBRGIZTINJWG44DSOR3HQ6T"
                    "4P2AIFBEGRCFIZDUQSKKJNGE2TSPKBIVEU2UKVLFOWCZLJNVYXK6L5QGCYTDMRSWMZ3INFVGW3DNNZXXA4LSON2HK5TXPB4XU634"
                    "PV7H7AEBQKBYJBMGQ6EITCULRSGY5D4QSGJJHFEVS2LZRGM2TOOJ3HU7UCQ2FI5EUWTKPKFJVKV2ZLNOV6YLDMVTWS23NN5YXG5L"
                    "XPF5X274BQOCYPCMLRWHZDE4VS6MZXHM7UGR2LJ5JVOW27MNTWW33TO55X7A4HROHZHF43T6R2PK5PWO33XP6DY7F47U6X3PP6HZ"
                    "7L57Z7P674======", 416, buffer, &buffer_size);
  check_uint_eq (256, buffer_size);
  check (memcmp ("\x00\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0a\x0b\x0c\x0d\x0e\x0f"
                 ...
                 "\xf0\xf1\xf2\xf3\xf4\xf5\xf6\xf7\xf8\xf9\xfa\xfb\xfc\xfd\xfe\xff", buffer, 256) == 0);
